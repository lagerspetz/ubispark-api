...
class UbisparkException(message: String, cause: Throwable)
...
/**
  ...
  */
private class UbisparkDriverExecutionException(cause: Throwable)
  extends UbisparkException("Execution error", cause)
...
/**
  ...
  */
private case class UbisparkUserAppException(exitCode: Int)
  extends UbisparkException(s"User application exited with $exitCode")
